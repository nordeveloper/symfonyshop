...
{
    /**
     * @Route("/", name="ashboard_settings_index", methods={"GET"})
     */
    ...
    public function new(Request $request): Response
    {
        ...
        return $this->render('dashboard/settings/new.html.twig', [
            'setting' => $setting,
    ...
    {
        return $this->render('dashboard/settings/show.html.twig', [
            'setting' => $setting,
        ]);
    }
    ...
    public function edit(Request $request, Settings $setting): Response
    {
        ...
        return $this->render('dashboard/settings/edit.html.twig', [
            'setting' => $setting,
            'form' => $form->createView(),
        ]);
    }
